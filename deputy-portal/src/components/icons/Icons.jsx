// مجموعة أيقونات SVG موحدة (line icons)
const cn = (className) => `w-5 h-5 ${className || ''}`

export const IconDashboard = (p) => (
  <svg className={cn(p.className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export const IconPlus = (p) => (
  <svg className={cn(p.className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
